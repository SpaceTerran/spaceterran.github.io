...
First off, if you want to check out the GitHub repo, head on over here: [GitHub Repo Link]. Once you have downloaded all the files to your local environment, the first step you are going to want to do is create your `secrets.yaml` file.
